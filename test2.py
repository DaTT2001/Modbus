...
# API Endpoint
API_URL = "http://192.168.10.87:8080/api/t4"
...
#             print(f"✅ Dữ liệu đã gửi lên API: {timestamp} {temperatures}")
#         else:
...
def send_to_api(temperatures):
    ...
    api_endpoints = [
        ...
        "http://192.168.10.87:8081/api/v1/hYUzKwCZuGwwgqi1Q7rQ/telemetry"
    ]
